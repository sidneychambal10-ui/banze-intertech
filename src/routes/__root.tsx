  ...
  head: () => ({
    meta: [
      ...
      { title: "BANZE INTERTECH — Tecnologia, Jogos e Apps" },
      {
        name: "description",
        content:
          "Ecossistema profissional de tecnologia, jogos e aplicações integradas de Moçambique.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Orbitron:wght@500;700;800;900&family=Space+Grotesk:wght@400;500;600;700&display=swap",
      },
    ],
  }),
